...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Proc0_UtcApi_IsScenarioActive,
    (SERVER_ROUTINE)Proc1_UtcApi_EscalateScenario,
    (SERVER_ROUTINE)Proc2_UtcApi_EscalateScenarioAsync,
    (SERVER_ROUTINE)Proc3_UtcApi_IsEscalationRunning,
    (SERVER_ROUTINE)Proc4_UtcApi_DownloadLatestSettingsForNamespace,
    (SERVER_ROUTINE)Proc5_UtcApi_DownloadLatestSettingsForNamespaceAsync,
    (SERVER_ROUTINE)Proc6_UtcApi_GetActiveScenarioList,
    (SERVER_ROUTINE)Proc7_UtcApi_ForceUpload,
    (SERVER_ROUTINE)Proc8_UtcApi_ResetUsageMetrics,
    (SERVER_ROUTINE)Proc9_UtcApi_IsTraceRunning,
    (SERVER_ROUTINE)Proc10_UtcApi_GetActiveTraceRuntime,
    (SERVER_ROUTINE)Proc11_UtcApi_GetKnownTraceList,
    (SERVER_ROUTINE)Proc12_UtcApi_DownloadLatestSettings,
    (SERVER_ROUTINE)Proc13_UtcApi_ReloadSettings,
    (SERVER_ROUTINE)Proc14_UtcApi_UpdateTimerConfiguration,
    (SERVER_ROUTINE)Proc15_UtcApi_ClearTimerConfiguration,
    (SERVER_ROUTINE)Proc16_UtcApi_GetNextScheduledFireTime,
    (SERVER_ROUTINE)Proc17_UtcApi_GetTimerConfiguration,
    (SERVER_ROUTINE)Proc18_UtcApi_GetCustomTraceList,
    (SERVER_ROUTINE)Proc19_UtcApi_StartCustomTrace,
    (SERVER_ROUTINE)Proc20_UtcApi_SnapCustomTrace,
    (SERVER_ROUTINE)Proc21_UtcApi_StopCustomTrace,
    (SERVER_ROUTINE)Proc22_UtcApi_EscalateScenario2,
    (SERVER_ROUTINE)Proc23_UtcApi_EscalateScenarioAsync2,
    (SERVER_ROUTINE)Proc24_UtcApi_GetActiveTraceInfo,
    (SERVER_ROUTINE)Proc25_UtcApi_EnableWERLocalReports,
    (SERVER_ROUTINE)Proc26_UtcApi_RestoreWERLocalReportsSettings,
    (SERVER_ROUTINE)Proc27_UtcApi_QueryWERLocalReportsEnabled,
    (SERVER_ROUTINE)Proc28_UtcApi_IsEscalationRunningEx,
    (SERVER_ROUTINE)Proc29_UtcApi_QueryDiagnosticCollectionState,
    (SERVER_ROUTINE)Proc30_UtcApi_EscalateScenario3,
    (SERVER_ROUTINE)Proc31_UtcApi_GetIdsFromCategory,
    (SERVER_ROUTINE)Proc32_UtcApi_GetRunningTraces,
    (SERVER_ROUTINE)Proc33_UtcApi_GetContextProperty,
    (SERVER_ROUTINE)Proc34_UtcApi_GetRunningEscalationsForContext,
    (SERVER_ROUTINE)Proc35_UtcApi_EscalateScenarioAsync3,
    (SERVER_ROUTINE)Proc36_UtcApi_GetApiVersion,
    (SERVER_ROUTINE)Proc37_UtcApi_DownloadLatestSettings2,
    (SERVER_ROUTINE)Proc38_UtcApi_DownloadLatestSettingsForNamespace2,
    (SERVER_ROUTINE)Proc39_UtcApi_DownloadLatestSettingsForNamespaceAsync2
    };
...
static const MIDL_SERVER_INFO DefaultIfName_ServerInfo = 
    ...
    diag__MIDL_ProcFormatString.Format,
